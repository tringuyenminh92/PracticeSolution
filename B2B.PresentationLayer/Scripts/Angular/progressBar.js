...
angular.module('progress.bar', [])
	.directive('ngProgressbar', function ($timeout) {
	    return {
	        ...
	        restrict: 'E',
	        template: "<div class='progress progress-striped'><div class='progress-bar progress-bar-{{type}}' role='progressbar' style='width:{{percent_complete}}%;'>{{current}} / {{max}} seconds</div></div>",
	        replace: true,
	        scope: {
	            max: '@',
	            start: '@',
